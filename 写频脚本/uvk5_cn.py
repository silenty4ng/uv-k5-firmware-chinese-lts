...
KEYACTIONS_LONG_LIST = ["无", "手电筒", "切换发射功率", "监听", "扫描", "声控发射", "ALARM", "FM收音机", "1750HZ", "锁定按键", "切换AB信道",
                        "切换信道模式", "切换调制模式", "关闭背光", "DTMF解码", "切换宽窄带", "A信道发射", "B信道发射", "副信道发射"]

KEYACTIONS_SHORT_LIST = ["无", "手电筒", "切换发射功率", "监听", "扫描", "声控发射", "ALARM", "FM收音机", "1750HZ", "锁定按键", "切换AB信道",
                        "切换信道模式", "切换调制模式", "关闭背光", "DTMF解码", "切换宽窄带"]
...
#                                "in the range %.1f - %.1f" % (FMMIN , FMMAX))
            ...
            if element.get_name() == "mdc_audio_local":
                _mem.mdc_audio_local = bool(element.value)
