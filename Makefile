...
ifeq ($(ENABLE_GENERAL),1)
    PACKED_FILE_SUFFIX := $(PACKED_FILE_SUFFIX)G1
endif

ifeq ($(ENABLE_GENERAL),2)
...
CFLAGS += -DENABLE_GENERAL=$(ENABLE_GENERAL)
...
bothandgeneral:
	...
	$(MAKE) build ENABLE_CHINESE_FULL=0
	$(MAKE) build ENABLE_CHINESE_FULL=4
	$(MAKE) build ENABLE_CHINESE_FULL=0 ENABLE_GENERAL=1
	$(MAKE) build ENABLE_CHINESE_FULL=0 ENABLE_GENERAL=2
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_GENERAL=1
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_GENERAL=2
